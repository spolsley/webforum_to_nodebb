...
url_stack.append('http://www.ambrosiasw.com/forums/index.php?showforum=17&prune_day=100&sort_by=Z-A&sort_key=last_post&topicfilter=all&st=0')
forum = 17 # forum number to save (change with start url if necessary)

# Cythera Chronicles (64)
# url_stack.append('http://www.ambrosiasw.com/forums/index.php?showforum=64&prune_day=100&sort_by=Z-A&sort_key=last_post&topicfilter=all&st=0')
# forum = 64 # forum number to save (change with start url if necessary)
